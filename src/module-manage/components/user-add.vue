      ...
      this.$refs.dataForm.validate((valid) => {
        if (valid) {
          ...
          if (this.formBase.id) {
            const res = {};
            res.avatar = "";
            res.email = this.formBase.email;
            res.id = this.formBase.id;
            res.introduction = this.formBase.introduction;
            res.permission_group_id = this.formBase.permission_group_id;
            res.phone = this.formBase.phone;
            res.role = this.formBase.role;
            res.username = this.formBase.username;
